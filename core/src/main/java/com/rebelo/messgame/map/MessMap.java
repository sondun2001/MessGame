...
public class MessMap extends InputAdapter implements TileBasedMap, IGamePadConsumer
{
    ...
    public void updateAndRender(OrthographicCamera camera, Matrix4 cameraMatrix)
    {
        ...
        // todo: When moving to ASHLEY, we can pool the physics body by making
        ...
        for (GameObject obj : _gameObjects) {
            ...
            // TODO: Lights need to check if they are in bounds also
            if (obj.type == GameObject.TYPE_LIGHT_POINT || obj.type == GameObject.TYPE_LIGHT_CONE) {
                obj.setActive(_currentAmbientLight < 0.3);
            }
        }
    ...
    public boolean blocked(PathFindingContext context, int tx, int ty)
    {
        ...
        {
            int id = cell.getTile().getId();
            // TODO: What is 1? Save as enum, can we use types instead of id
            // or a map of blocked types
            if (id == 1) return true;
        }
    ...
    public float getCost(PathFindingContext context, int tx, int ty) {
        ...
        // TODO: Take into account other tiles
        return 1;
    }
}
