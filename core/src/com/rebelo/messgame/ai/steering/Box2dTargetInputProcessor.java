...
/** An {@link InputProcessor} that allows you to manually move a {@link Box2dSteeringEntity}.
 * 
 * @autor davebaol */
public class Box2dTargetInputProcessor extends InputAdapter {
	...
	protected void setTargetPosition(int screenX, int screenY) {
		...
		pos.x = (screenX / MessGame.PIXELS_PER_METER);
		pos.y = (screenY / MessGame.PIXELS_PER_METER);
